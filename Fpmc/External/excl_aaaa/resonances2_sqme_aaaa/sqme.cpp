...
namespace resonances2_aaaa
{
  ...
  // Computes the exotic spin 2  squared matrix element and the SM interference
  double
  sqme( double s, double t, int exclude_loops_SM, int exclude_loops_EX, double m, double c, double w_c, double aa )
  {
    double mass = m;
    double f0 = c;
    double w_const = w_c;
    ...
    Mpppp_spin2(s, t, mass, f0, w_const,a2, re_ex, im_ex);
