...
namespace resonances0even_gluglu
{
  void
  ...
  double
  sqme( double s, double t, int exclude_loops_SM, int exclude_loops_EX, double m, double c, double cg, double w_c, double aa )
  {
    double mass = m;
    double f0 = c;
    double f0g = cg;
    ...
    Mggpppp_spin0even(s, t, mass, f0, f0g, w_const,a2, re_ex, im_ex);
    value += ( re_ex*re_ex + im_ex*im_ex );

    // repeat for the other helicities

    // Mppmm:
    Mggppmm_spin0even(s, t, mass, f0, f0g, w_const,a2, re_ex, im_ex);
    value += ( re_ex*re_ex + im_ex*im_ex );

    // Mpmmp:
    Mggpmmp_spin0even(s, t, mass, f0, f0g, w_const,a2, re_ex, im_ex);
    value += ( re_ex*re_ex + im_ex*im_ex );

    // Mpmpm:
    Mggpmpm_spin0even(s, t, mass, f0, f0g, w_const,a2, re_ex, im_ex);
    value += ( re_ex*re_ex + im_ex*im_ex );

    // Mpppm
    Mggpppm_spin0even(s, t, mass, f0, f0g, w_const,a2, re_ex, im_ex);
    value += ( re_ex*re_ex + im_ex*im_ex );
