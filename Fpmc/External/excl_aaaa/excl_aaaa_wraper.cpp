...
void
resonances0even_sqme_zz_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _cz, double* w_c, double* aa )
{
  *mp2 = resonances0even_zz::sqme(*s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_cz, *w_c, *aa);
}
...
void
resonances0evenoh_sqme_zz_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _cz, double* w_c, double* aa )
{
  *mp2 = resonances0evenoh_zz::sqme( *s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_cz, *w_c, *aa );
}
...
void
resonances0even_sqme_ww_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _cw, double* w_c, double* aa )
{
  *mp2 = resonances0even_ww::sqme(*s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_cw, *w_c, *aa);
}
...
void
resonances0even_sqme_hh_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _cw, double* w_c, double* aa )
{
  *mp2 = resonances0even_hh::sqme( *s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_cw, *w_c, *aa );
}
...
void
resonances0even_sqme_gluglu_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _cw, double* w_c, double* aa )
{
  *mp2 = resonances0even_gluglu::sqme( *s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_cw, *w_c, *aa );
}
...
void
resonances0even_sqme_az_c_( double* mp2, double* s, double* t, int* exclude_loops_SM, int* exclude_loops_EX, double* m, double* c, double* _czg, double* w_c, double* aa )
{
  *mp2 = resonances0even_az::sqme( *s, *t, *exclude_loops_SM, *exclude_loops_EX, *m, *c, *_czg, *w_c, *aa );
}
